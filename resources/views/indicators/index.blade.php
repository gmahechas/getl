                    ...
                    @else
                        <table class="table table-sm table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>Nb des factures reçue dans la periode (Q):</td>
                                ...
                                <tr>
                                    <td>9</td>
                                    <td>% des factures payées dans la periode <= 30 jours pafr rapport au NFPP:</td>
                                    <td>{{ number_format($indicator_4['result'][0]->count_invoices / $indicator_2['result'][0]->count_invoices, 2) }}</td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>10</td>
                                    <td>Temps de moyenne de traitement des factures reçues dans la periode:</td>
                                    <td>&nbsp;</td>
                                    <td>{{ number_format($indicator_1['result'][0]->avg_duration,2) }}</td>
                                </tr>
                                <tr>
                                    <td>11</td>
                                    <td>Temps moyenne de traitement des factures payées dans la periode:</td>
                                    <td>&nbsp;</td>
                                    <td>{{ number_format($indicator_2['result'][0]->avg_duration,2) }}</td>
                                </tr>
                                <tr>
                                    <td>12</td>
                                    <td>Temps moyenne de traitment des factures > 30 jours payées pendants la periode:</td>
                                    <td>&nbsp;</td>
                                    <td>{{ number_format($indicator_3['result'][0]->avg_duration,2) }}</td>
                                </tr>
                                <tr>
                                    <td>13</td>
                                    <td>Temps moyenne de traitement des factures <= à 30 jours payées dans la periode:</td>
                                    <td>&nbsp;</td>
                                    <td>{{ number_format($indicator_4['result'][0]->avg_duration,2) }}</td>
                                </tr>
                                <tr>
                                    <td>14</td>
                                    <td>Temps moyenne de traitement des factures reçues dans la periode:</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td>16</td>
                                    <td>emps moyenne de traitement des factures < = à 30 jours payées dans la periode:</td>
                                    <td>&nbsp;</td>
